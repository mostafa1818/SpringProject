...
//         List<String> invesments=invesmentService.findAllUserNameOfInvesment();
//        Set<String> distinct = new HashSet<>(invesments);
//        Map<String,Integer> outPut=new HashMap<>();
//        for (String s: distinct) {
//            outPut.put(s,Collections.frequency(invesments, s));
////            System.out.println(s + ": " + Collections.frequency(invesments, s));
//        }
//
